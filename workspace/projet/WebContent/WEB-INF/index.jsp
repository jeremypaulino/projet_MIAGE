...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="./inc/css/slider.css">
    ...
    <script src="./inc/js/tms-0.4.x.js"></script>
    <script>
	...
	<!--[if lt IE 8]>
       <div style=' clear: both; text-align:center; position: relative;'>
         <a href="http://windows.microsoft.com/en-US/internet-explorer/products/ie/home?ocid=ie6_countdown_bannercode">
           <img src="http://storage.ie6countdown.com/assets/100/./inc/images/banners/warning_bar_0000_us.jpg" border="0" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today." />
        </a>
      </div>
    <![endif]-->
    <!--[if lt IE 9]>
  ...
  <!--==============================content================================-->
    <section id="content">
        <div id="slide" class="box-shadow">		
            <div class="slider">
                <ul class="items">
                    <li><img src="./inc/images/slider-1.jpg" alt="" /><div class="banner">Le Succes Garantie Pour Vos Études&nbsp;</div></li>
                    <li><img src="./inc/images/slider-2.jpg" alt="" /><div class="banner">Des Professeurs Qualifiés Á Votre Disposition&nbsp;</div></li>
                    <li><img src="./inc/images/slider-3.jpg" alt="" /><div class="banner">Des Cours Personnalisés Selon Vos Besoins&nbsp;</div></li>
                </ul>
            </div>	
        </div>
        <div class="container_12">
          <div class="grid_12">
            <div class="pad-0 border-1">
                ...
                <p class="p2">iSchool est une plateforme intéractive qui met à la disposition d'élève, un large panel de cours virtuels. Que vous soyez collègien ou étudiant en école d'ingénieur, iSchool est fait pour vous! En effet des professeurs de collège, de lycée et universitaire, séléctionnés par nos soins, vous attendent. </p>
            </div>
            <div class="wrap block-1 pad-1">
                <div>
                    <h3>Les Meilleurs Pour Vous</h3>
                    <img src="./inc/images/page1-img1.jpg" alt="" class="img-border">
                    <p>Nous selectionnons nous même les professeurs présent sur le site. Ils sont choisis grâce à leur expérience.</p>
                    <a href="#" class="button">Plus</a>
                </div>
                <div>
                    <h3>deuxieme zone</h3>
                    <img src="./inc/images/page1-img2.jpg" alt="" class="img-border">
                    <p>blabla</p>
                    <a href="#" class="button">Plus</a>
                </div>
                <div class="last">
...
<!--==============================footer=================================-->
    <footer>
        <p>© 2014 iSchool</p>
        <p>Website project by <a href="http://ibisc.fr" target="_blank" rel="nofollow">Evry University</a></p>
    </footer>	    
</body>
</html>