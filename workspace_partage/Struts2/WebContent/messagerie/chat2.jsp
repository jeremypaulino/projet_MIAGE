...
<link href="messagerie/css/bootstrap.css" rel="stylesheet">


<link href="messagerie/css/font-awesome.css" rel="stylesheet">
<link href="messagerie/css/style.css" rel="stylesheet" type="text/css">

<link href="messagerie/less/style.less" rel="stylesheet" title="lessCss" id="lessCss">


<link href="messagerie/css/custom.css" rel="stylesheet">

<link rel="shortcut icon" href="messagerie/images/favicon.ico">
...
<!--       <![endif] -->
	...
	<script src="messagerie/js/jquery-1.10.2.min.js"></script>
	<script src="messagerie/js/jquery-ui-1.10.3.custom.min.js"></script>
	<script src="messagerie/js/less-1.5.0.min.js"></script>
	<script src="messagerie/js/jquery.ui.touch-punch.min.js"></script>
...
<body>
					...
					<div class="panel panel-cascade recipient-box">
						<div class="panel-heading">
							<h3 class="panel-title ">
								<span class="recipient"> <img src="messagerie/images/profile50x50.png" class="chat-user-avatar" alt=""> Philippe Declercq <i
	...
	<script src="messagerie/js/bootstrap.min.js"></script>
	<script src="messagerie/js/bootstrap-select.js"></script>
	<script src="messagerie/js/bootstrap-switch.js"></script>
	<script src="messagerie/js/jquery.tagsinput.js"></script>
	<script src="messagerie/js/jquery.placeholder.js"></script>
	<script src="messagerie/js/bootstrap-typeahead.js"></script>
	<script src="messagerie/js/application.js"></script>
	<script src="messagerie/js/moment.min.js"></script>
	<script src="messagerie/js/jquery.dataTables.min.js"></script>
	<script src="messagerie/js/jquery.sortable.js"></script>
	<script type="text/javascript" src="messagerie/js/jquery.gritter.js"></script>
	<script src="messagerie/js/jquery.nicescroll.min.js"></script>
	<script src="messagerie/js/skylo.js"></script>
	<script src="messagerie/js/prettify.min.js"></script>
	<script src="messagerie/js/jquery.noty.js"></script>
	<script src="messagerie/js/bic_calendar.js"></script>
	<script src="messagerie/js/jquery.accordion.js"></script>
	<script src="messagerie/js/theme-options.js"></script>

	<script src="messagerie/js/bootstrap-progressbar.js"></script>
	<script src="messagerie/js/bootstrap-progressbar-custom.js"></script>
	<script src="messagerie/js/bootstrap-colorpicker.min.js"></script>
	<script src="messagerie/js/bootstrap-colorpicker-custom.js"></script>
...
$('document').ready(function(){
	...
	var email_sess="<s:property value='#session.email' />";
		$.ajax({
			url : "contactupdate",
			data : {
			...
			success : function(data) {	
				...
				for( var i = 0 ; i<data.listeContact.length ; i++){			
					string = string + '<li id="'+data.listeContact[i+2]+'"><a class="list-group-item"> <img src="messagerie/images/profiles/four.png" class="chat-user-avatar" alt=""> '+data.listeContact[i]+' '+ data.listeContact[i+1]+'<i class="fa fa-circle offline"></i></a></li>';
		...
		$.ajax({
			...
			success : function(data) {	
				...
				for( var i = 0 ; i<data.list.length ; i++){			
					...
					if(data.list[i+1]=="<s:property value='#session.email' />"){
						send_message('messagerie/images/profiles/one.png',"Moi",data.list[i],data.list[i+3]);
					}else{
						send_message('messagerie/images/profiles/one.png',data.list[i+2],data.list[i],data.list[i+3]);
					}
					i++;
					i++;
					i++;
					//send_message('images/profiles/one.png',,vj);
	...
	$('#send-message').click(function(){
		...
		var d = new Date();
		var timeNow=d.getUTCFullYear()+'-'+"0"+(d.getUTCMonth()+1)+'-'+d.getUTCDate()+" " +d.getHours()+':'+d.getMinutes()+':'+d.getSeconds();
		send_message('messagerie/images/profiles/one.png','Moi',vj,timeNow);
		var Email_envoy= "<s:property value='#session.email' />";
	...
	function send_message(image,username,message,date)
	{
		//var d = new Date();
		//var timeNow=d.getHours()+':'+d.getMinutes()+':'+d.getSeconds();
		
		var container = $('.conversation');
		container.append('<a class="list-group-item"><img src="'+image+'" class="chat-user-avatar" alt="" /><span class="username" >'+username+'<span class="time">'+date+'</span> </span><p>'+message+'</p></a>');
	...
	<script src="messagerie/js/core.js"></script>
