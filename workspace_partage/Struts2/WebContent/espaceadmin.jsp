							...
							<table id="table" class="tableAdmin">
								<s:iterator value="listeProf" var="element">
									<tr>
										...
										<td><a href="<s:url action="accepterProf"><s:param  name="email" value="mail" /></s:url>"><img src="images/valid.png" /></a></td>
										<td><a href="<s:url action="refuserProf"><s:param  name="email" value="mail" /></s:url>"><img src="images/invalid.png" /></a></td>
									</tr>
								</s:iterator>
							</table>
						...
						<div>
							...
							<table class="tableAdmin">
								...
								<s:iterator value="listeAdmin" var="element">
									<tr>
										<td><s:property /></td>
										<td><a href="<s:url action="supprimerAdmin"><s:param  name="email" value="element" /></s:url>"><img src="images/delete.png" /></a></td>
									</tr>
								</s:iterator>
							</table>
							<p>
						...
						<div class="last">
							...
							<table class="tableAdmin">
								<s:iterator value="listeMatieres" var="element">
									<tr>
										<td><s:property /></td>
										<td><a href="<s:url action="supprimerMatiere"><s:param  name="matiere" value="element" /></s:url>"><img src="images/delete.png" /></a></td>
									</tr>
								</s:iterator>
							</table>
							<p>
					...
					<div class="grid_12">
						<div class="pad-2 block-2 wrap">
							...
							<div>
								...
								<a id="popupCA" class="button">semaine</a> <a id="popupCA" class="button">mois</a> <a id="popupCA" class="button">annee</a>
							</div>
							<div class="last">
							...
							<div class="last">
								...
								<h4>Aujourd'hui</h4>
								<p class="p4">145 h</p>
								<a href="#" class="button">semaine</a> <a href="#" class="button">mois</a> <a href="#" class="button">annee</a>
							</div>
						</div>
					</div>
				</div>
